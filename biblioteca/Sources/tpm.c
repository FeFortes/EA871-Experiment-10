 ...
 *
 * \date Aug 3, 2017
 * \author Wu Shin-Ting e Leandro Cavalcanti Silva
...
//		tpm_sc = &TPM_SC_REG(TPM0_BASE_PTR);
		tpm_sc = &TPM0_SC; //a linha de cima eh equivalente a esta
		...
		break;
	case 1:
		SIM_SCGC6 |= SIM_SCGC6_TPM1_MASK;        ///< TPM0=SIM_SCGC6[25]=1 (Clock gate de TPM1 habilitado)
		...
		break;
	case 2:
		SIM_SCGC6 |= SIM_SCGC6_TPM2_MASK;        ///< TPM0=SIM_SCGC6[26]=1 (Clock gate de TPM2 habilitado)
	...
	*tpm_sc |= (TPM_SC_TOF_MASK |            ///< TOF=TPMx_TOF[7]: w1c (limpa a pend&ecird;ncia do TPM0) 
				...
				TPM_SC_PS(pre) );            ///< PS=TPMx_SC[2:0]=0b100 (Fator Pr&eacute;-escala=16)
	if (cpwms)			
 ...
 * \param[in] c_modo modo de opera&ccedil;&atilde;o do canal (msb msa elsb elsa)
